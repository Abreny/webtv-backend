...
public class DeleteVideoRepositoryImpl implements DeleteVideoRepository {
    ...
    public void deleteAllByVideoId(Long videoId) {
       Query q = entityManager.createNativeQuery("delete you from video_youtube_tags you INNER JOIN video_youtube vy on vy.id = you.video_youtube_id where vy.video_id = :video_id");
